...
export class SkinMTXMaterial extends THREE.RawShaderMaterial {
  constructor(val: string | THREE.Texture = "cyan", poseBuffer: any = null) {
    ...
    super(matConfig);
    this.extensions.derivatives = true; // If not using WebGL2.0 and Want to use dfdx or fwidth, Need to load extension
  }
}
